...
2. Expand manual QA checklist across auth, profile, analyze, and status update flows.
3. Improve UX polish for loading/empty/error states.
4. Evaluate roadmap items (PDF resume, keyword optimizer upgrades, manual autofill helper) after MVP hardening.
